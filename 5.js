...
class Version {
  ...
  static #versions = []; // Масив версій тексту
  ...
  static restore() {
    ...
    // Коли викликається .pop() на масиві, він видаляє останній елемент 
    // з масиву і повертає його значення. Після виклику методу .pop(), 
    // розмір масиву зменшується на одиницю, оскільки останній елемент був видалений.
  }
}
